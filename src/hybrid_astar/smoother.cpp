...
void Smoother::smoothPath(DynamicVoronoi& voronoi) {
  ...
  while (iterations < maxIterations) {
    ...
    for (int i = 2; i < pathLength - 2; ++i) {
      ...
      //YT error orientation, shouldn't change
...
//  {
//  std::cout << "YT: path after voronoi["
//            << i
//            << "] = "
//            << this->path.at(i).pose.position.x
//            << ", "
//            << this->path.at(i).pose.position.y
//            << ", ["
//            << this->path.at(i).pose.orientation.x
//            << ", "
//            << this->path.at(i).pose.orientation.y
//            << ", "
//            << this->path.at(i).pose.orientation.z
//            << ", "
//            << this->path.at(i).pose.orientation.w
//            << "] "
//            << tf::getYaw(this->path.at(i).pose.orientation)
//            << std::endl;
//}
}
...
Vector2D Smoother::curvatureTerm(Vector2D xim1, Vector2D xi, Vector2D xip1) {
  ...
  //std::cout << "YT: in smoother.cpp, absDxi = " << absDxi << ", absDxip1 = " << absDxip1 << std::endl;
